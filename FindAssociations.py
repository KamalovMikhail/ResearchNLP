...
def main():
   # if len(sys.argv) < 2:
    #    sys.stderr.write("/home/mikhail/Desktop/io/sample.txt [0.85]\n")
     #   sys.exit(1)
    ...
    sentences = tokenize("/home/mikhail/Desktop/io/sample.txt")
    ...
    start_time = time.time()
    rules = generate_rules('conv', supps, len(sentences))
    for rule in rules:
        print ("{{{}}} -> {{{}}}, "
